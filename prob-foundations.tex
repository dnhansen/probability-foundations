...
\definecolor{linkcolor}{HTML}{6b6bb3}
\hypersetup{%
	pdftitle=\doctitle,
	pdfauthor=\docauthor,
	colorlinks,
...
% \usepackage{latex-sty/mdtheoremfix}
\usepackage[new]{latex-sty/framedtheorems}
\usepackage{latex-sty/theoremrefs}
\definecolor{chaptercolor}{HTML}{6b6bb3}
% \definecolor{titlecolor}{HTML}{61496b}
% \definecolor{backgroundcolor}{HTML}{fbf2ff}
...
\renewcommand{\rvar}[1]{\text{\textup{\textsf{#1}}}}
...
\begin{definition}[$\delta$-systems]
